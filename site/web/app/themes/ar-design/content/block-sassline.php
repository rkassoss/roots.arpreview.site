<section id="sassline-style">
					<script>
						jQuery( document ).ready(function( $ ) {
							// TYPESET GRID
							$("#show_grid").on("click", function() {
								$(".sassline-content").toggleClass("show-grid");
							});
						});
					</script>
					
					<button type="button" class="btn btn-secondary pull-right" id="show_grid">Show Grid</button>
					
					<div class="sassline-content">
						<div class="section typeset">
					      <div class="single-measure">
					        <h1>Sassline Testing Text Lorem ipsum</h1>
					...
					</div> <!-- END SASSLINE CONTENT -->
				</section> <!-- END #SASSLINE_STYLE -->